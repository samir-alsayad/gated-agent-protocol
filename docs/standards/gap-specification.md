...
| Phase | Internal ID | Purpose | Typical Output |
| :--- | :--- | :--- | :--- |
| **Understand** | `gate_intent` | Capture user intent and constraints | `intent.md` |
| **Design** | `gate_invariant` | Define architectural/formal invariants | `spec.md` / `invariants.md` |
| **Path** | `gate_path` | Decompose work into actionable steps | `plan.md` / `protocol.md` |
| **Synthesis** | `gate_synthesis` | Execute work and provide proof | Code / Report + `walkthrough.md` |
